...
//           Welcome to Retro Insurace {loginType} Login
//         </h4>
    ...
    <>
      ...
      <div className="maindiv">
        <div className="image-info">
          <img
            src="/assets/images/Login_Screen.png"
            alt="Avatar"
            class="avatar"
          />
        </div>
        ...
        <form onSubmit={handleSubmit(handleLogin)} className="form-pos-login">
          ...
          <div className="container">
            <label for="uname" className="label-class-name">
              <b>Email</b>
            </label>
            forgetpassword
            <input
          ...
          <label className="remember">
            ...
            <span className="forgot-password-class">
              <Link to="/forgetpasssword">Forgot Password?</Link>
            </span>
          </label>
          {/* <hr /> */}
